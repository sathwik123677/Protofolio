        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-12 md:py-20">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-foreground/70">
                Computer Science Undergraduate | Full-Stack Developer | ML Engineer | Competitive Programmer
              </p>
            </div>

            <p className="text-base text-foreground/60 leading-relaxed">
              Passionate about building scalable web applications, solving complex algorithms, and
              implementing robust machine learning solutions. Currently pursuing B.Tech at NIT Patna
              with deep expertise in full-stack development, ML, and competitive programming.
            </p>
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <img
                src="https://cdn.builder.io/api/v1/image/assets%2F2316f2c44ded4926a256d7e0e9cb417f%2F7b6dc84ba39a4a70a7b9df7b911603a0?format=webp&width=800"
