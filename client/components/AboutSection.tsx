...
export default function AboutSection() {
  const highlights = [
    ...
    "Deep interest in machine learning and AI-driven solutions",
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-base text-foreground/70 leading-relaxed">
              ...
              <p>
                Whether it's developing full-stack applications, optimizing algorithms, or exploring machine learning, I approach every project with dedication and a commitment to clean, maintainable code.
              </p>
            </div>
